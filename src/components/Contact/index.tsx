...
const Contact = () => (
  <div className="container grid grid-cols-2 h-[80vh] items-center justify-center">
    <div className="flex flex-col gap-10">
      <h1 className="font-bold text-4xl">
        Estamos aqui para ajudá-lo! Para moldar seu corpo.
      </h1>
      <p className="font-medium text-zinc-600">
        Na BodyFit, nos dedicamos a ajudá-lo a alcançar o corpo dos seus sonhos.
        Nossos treinadores e nutricionistas especializados trabalharão com você
        para criar um plano personalizado de condicionamento físico e nutrição
        que o ajudará a atingir seus objetivos específicos.
      </p>
